...
const About = () => {
  return (
    ...
    <br />
          ...
          <a href="src\assets\cv.pdf" download><button className="btn btn-primary btn--large"> Baixar cúrriculo </button></a>
          
        </div>
        <img className={AboutCss.Picture} src="src\assets\profile.jpg" alt="My profile picture" />
      </div>
      <Skills></Skills>
    </section>
  );
