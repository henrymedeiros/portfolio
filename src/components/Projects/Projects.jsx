...
const Projects = ({ setCurrentProject, setOpenModal }) => {
  let projects = [
    ...
    
    {
      ...
      description: 'Meu portfólio pessoal, desenvolvido com React e SASS. O projeto foi desenvolvido com o objetivo de praticar e aprimorar meus conhecimentos e de ser um repositório para demonstrar meus melhores projetos e habilidades.',
      links: { demoLink: "", codeLink: "https://github.com/henrymedeiros/portfolio" },
    },
    {
      name: "Portal de Disciplinas",
      imgSrc: "/assets/portalDisciplinas.png",
      setOpenModal: setOpenModal,
      setCurrentProject: setCurrentProject,
      tags: ["Javascript", "Blade Template", 'Laravel', 'PHP', "Bolsista"],
      description: "Projeto no qual atuo como bolsista Front-end e elaboro o design das páginas e desenvolvo os layouts.",
      links: { demoLink: "https://portaldasdisciplinas.imd.ufrn.br/", codeLink: "" },
    },
    {
